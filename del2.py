...
class GridApp:
    def __init__(self, master=None):
        ...
        tk.Grid.rowconfigure(frame1, 1, weight=1)
        ...
        tk.Grid.columnconfigure(frame1, 4, weight=1)

        label3 = tk.Label(frame1)
        label3.configure(text='Broker')
        label3.grid(column=0, row=0, sticky="NSEW")
        ...
        button3.grid(column=4, row=1, sticky="E")
        label5 = tk.Label(frame1)
        label5.configure(text='Subscribe')
        label5.grid(column=0, row=2)
        listbox2 = tk.Listbox(frame1)
        listbox2.configure(activestyle="dotbox")
        listbox2.grid(column=1, row=3, sticky="NSEW")
